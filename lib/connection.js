 ...
 * @param  {String} [options.deadLetterExchange] - An exchange to which messages discarded from the queue will be resent. A message is discarded when it expires or is rejected or nacked, or the queue limit is reached.
 * @return {Queue}
 */
