...
var c = new Connection('amqp://guest:guest@127.0.0.1:5672/', {exchange: 'jobs', autoDelete: true, durable: false})

function green (str) {
  return '\u001b[32m' + str + '\u001b[39m'
}

var worker1 = c.queue('jobs', {maxConcurrent: 20, durable: false, autoDelete: true})
var worker2 = c.queue('jobs', {maxConcurrent: 10, durable: false, autoDelete: true})
